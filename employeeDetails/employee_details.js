const employees = [
      ...
      { id: 3, name: 'Bob Johnson', age: 35, department: 'Finance', salary: 60000, specialization: "Paco" },
...
function findEmployeeById(employeeId) {
 ...
 function findBySpecialization(employeSpecialization) {
    const foundEmployee = employees.find(employee => employee.specialization === employeSpecialization);
    if (foundEmployee) {
